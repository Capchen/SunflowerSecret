import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as e,a as l}from"./app-75d14cdb.js";const i={};function c(r,n){return s(),e("div",null,n[0]||(n[0]=[l(`<h3 id="文件操作" tabindex="-1"><a class="header-anchor" href="#文件操作" aria-hidden="true">#</a> 文件操作</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">ls</span> <span class="token comment">#查看目录下文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18)]))}const p=a(i,[["render",c],["__file","基本的shell命令.html.vue"]]);export{p as default};
